...
def solve_all(wind_std, wind_angle):
    ...
    if OPEN_PARACHUTE == 0:
        ...
        print("launch clear calculation start")
        time_sta = time.perf_counter()
        
        solve_phase_1 = solve(phase_1, wind_std, wind_angle, X0_phase_1, 0, launch_clear)
        
        time_end = time.perf_counter()
        print("launch clear calculation end\n", "time: ", time_end - time_sta, "s")
        ...
        time_end = time.perf_counter()
        print("time: ", time_end - time_sta, "s")
        print("Area1 process end")
        
        
        print("Area2-1-1 process start")
        time_sta = time.perf_counter()
        ...
        time_end = time.perf_counter()
        print("time: ", time_end - time_sta, "s")
        print("Area2-1-1 process end")
        
        print("Area2-1-2-1 process start")
        """Area2-1-2が非常に遅い。
        6秒もかかっておりこれは全体の半分の実行時間である。
        """
        time_sta = time.perf_counter()

        Fn_align = Vectors.Fn_align(altitude, airflow_align)    #ここが遅い2s
        
        time_end = time.perf_counter()
        print("time: ", time_end - time_sta, "s")
        print("Area2-1-2-1 process end")
        
        print("Area2-1-2-2 process start")
        time_sta = time.perf_counter()
        ...
        time_end = time.perf_counter()
        print("time: ", time_end - time_sta, "s")
        print("Area2-1-2-2 process end")
        
        print("Area2-1-2-3 process start")
        time_sta = time.perf_counter()
        ...
        time_end = time.perf_counter()
        print("time: ", time_end - time_sta, "s")
        print("Area2-1-2-3 process end")
        
        print("Area2-2 process start")
        time_sta = time.perf_counter()
        ...
        time_end = time.perf_counter()
        print("time: ", time_end - time_sta, "s")
        print("Area2-2 process end")


        print("Area3 process start")
        time_sta = time.perf_counter()
        ...
        time_end = time.perf_counter()
        print("time: ", time_end - time_sta, "s")
        print("Area3 process end")
        
        
        print("Area4 process start")
        time_sta = time.perf_counter()
